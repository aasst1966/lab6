...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int[] transPhotoIsArray = new int[]{R.drawable.trans1, R.drawable.trans2, R.drawable.trans3, R.drawable.trans4};

        Data[] transData = new Data[transNameArray.length];
        for (int i = 0; i < transData.length; i++) {
            transData[i] = new Data();
            transData[i].name = transNameArray[i];
            transData[i].photo = transPhotoIsArray[i];
        }
        ...
        String[] cubeeNameArray = new String[]{"哭哭", "發抖", "再見", "生氣", "暈倒", "竊笑", "好棒", "你好", "驚嚇", "大笑"};
        ...
        MyAdapter cubeeAdapter = new MyAdapter(cubeeData, R.layout.cube_list);
